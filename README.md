...
* Вы можете использовать свой файл (не перезаписывается при обновлении) стилей и промтов [поместите файл в папку \extensions\sd-webui-oldsix-promptRU\yours в формате: "Название вкладки.json"
